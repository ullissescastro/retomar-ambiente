...
appid := 'io.github.ullissescastro.RetomarAmbiente'
...
# Builds and installs the application only for the current user.
install-user:
    ./install-user.sh

# Removes the user-level installation and preserves preferences.
uninstall-user:
    ./uninstall-user.sh
